...
<body>
    <div class="table-responsive jumbotron">
        ...
        <table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
            ...
            $no = 1;
            $tampil = mysqli_query($conn, "select * from wo");
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn-danger" onclick="return confirm('Apakah file ingin dihapus?')" href="../config/hapus_wo.php?id=<?php echo $data['id']; ?> "><i class="fa fa-trash" style="padding: 3px; border-radius:30%;"></i></a>
                        </td>
                    </tr>
                </tbody>
            <?php
